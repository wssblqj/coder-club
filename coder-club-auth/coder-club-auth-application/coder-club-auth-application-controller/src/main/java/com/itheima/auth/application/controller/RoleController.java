...
import com.itheima.auth.application.convert.AuthRoleDTOConverter;
...
public class RoleController {
    ...
    public Result<Boolean> add(@RequestBody AuthRoleDTO authRoleDTO) {
        try {
            ...
            return Result.ok(authRoleDomainService.insert(authRoleBO));
        } catch (Exception e) {
            log.error("RoleController.add.error: {}", e.getMessage());
