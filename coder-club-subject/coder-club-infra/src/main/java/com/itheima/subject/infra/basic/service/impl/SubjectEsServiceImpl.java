...
import com.itheima.subject.infra.basic.entity.EsSubjectFields;
import com.itheima.subject.infra.basic.entity.SubjectInfoEs;
import com.itheima.subject.infra.basic.es.EsIndexInfo;
import com.itheima.subject.infra.basic.es.EsRestClient;
import com.itheima.subject.infra.basic.es.EsSearchRequest;
import com.itheima.subject.infra.basic.es.EsSourceData;
...
public class SubjectEsServiceImpl implements SubjectEsService {
    ...
    private EsSearchRequest createSearchListQuery(SubjectInfoEs req) {
        ...
        bq.should(subjectNameQueryBuilder).should(subjectAnswerQueryBuilder);
    ...
    private EsIndexInfo getEsIndexInfo() {
        ...
        esIndexInfo.setClusterName("610119a868fb");
